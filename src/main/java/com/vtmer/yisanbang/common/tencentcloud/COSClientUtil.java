package com.vtmer.yisanbang.common.tencentcloud;
...
public class COSClientUtil {
    ...
    private static final String bucketName = "yisanbanng-1301185773";

    private static final String secretId = "AKID784BnIjnh9nJfuM98Ywz1nZkssjTBpV0";

    private static final String secretKey = "XzGuIajkaJ3h9TcimDh5JOctDNVWPdVV";

    private static final String objectPath = "https://yisanbanng-1301185773.cos.ap-chengdu.myqcloud.com/";
